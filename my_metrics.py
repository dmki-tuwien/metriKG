...
#     def find_all_paths_subclasses(start_node):
#         nonlocal sparql
#         nonlocal bnode_subclassOf
#         nonlocal bnode_superclassOf
...
#             nonlocal num_paths_inh_tree, max_depth_inh_tree
...
#             neighbors = list(get_subclasses(node)) 
...
#     results = _send_query(query_num_nodes,sparql,JSON)
...
#     # dictionary for all paths
#     all_paths = {}

#     # calculating all subclass paths form tree nodes
#     for root in tree_roots:
#         all_paths[root] = find_all_paths_subclasses(root)
...
def cohesion_endpoint(endpoint_url: str, default_graph: str | None = None, dec_places: int = 2) -> pd.DataFrame:
    ...
    # 3. gettin all neighbors of literals to store them
